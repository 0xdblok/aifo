...
export default function Home() {
  return (
    <div className="bg-grey-200 flex justify-center w-full  ">
      <a className="text-blue-500 bg-grey-800 hover:text-blue-700 text-xl mr-16 font-bold" href="/lela">
        Other page 
      </a>
 
<form class="flex text-green-200 flex-col max-w-screen-md bg-black" aria-labelledby="createAgentForm">
  ...
  <div class="flex flex-wrap gap-5  justify-between w-full text-white max-w-[542px] max-md:max-w-full">
    <div class="flex flex-col ">
      ...
      <div class="flex gap-2 self-end mt-2">
        ...
        <div class="  text-green-200 my-auto text-sm leading-loose">Enter details</div>
      </div>
    </div>
    <div class="flex gap-2 self-end mt-11 max-md:mt-10">
      ...
      <div class="text-green-200 my-auto text-sm leading-loose">Set amount</div>
    </div>
  </div>

  <div class="flex flex-col mt-4 w-full max-md:max-w-full">
    <h2 class="text-2xl font-bold leading-none text-green-200">Basic</h2>
    ...
    <label class="flex overflow-hidden flex-col justify-center px-4 py-5 mt-2 w-full text-base rounded-2xl border border-dashed border-white border-opacity-20 min-h-[108px] text-white text-opacity-60 max-md:max-w-full" for="agentPhoto">
      <div class="flex flex-wrap gap-5 py-1 pr-20 w-full max-md:pr-5 max-md:max-w-full">
        ...
        <div class="flex flex-col text-green-200 items-start">
          <div class="self-stretch text-green-200">AI agent's profile photo*</div>
          <div class="mt-3">Drop a file or <span class="text-green-200">Browse</span></div>
    ...
    <div class="flex text-green-200 flex-col px-4 mt-2 w-full rounded-2xl bg-neutral-900 min-h-[56px] max-md:max-w-full">
    ...
    <div class="flex flex-col py-6 mt-2 w-full rounded-2xl bg-neutral-900 max-md:max-w-full">
      <div class="flex flex-col items-start px-4 w-full max-md:max-w-full">
        <label class="text-base font-bold leading-loose text-green-200" for="agentLanguage">Agent Language</label>
        <div class="mt-3 text-sm leading-loose 0 text-opacity-60">Choose your preferred language for your agent</div>
    ...
    <div class="flex text-green-200 flex-col px-4 py-3 mt-2 w-full rounded-2xl bg-neutral-900 min-h-[104px] max-md:max-w-full">
      <label class="font-bold text-green-200 text-white" for="voiceStyle">Voice Style*</label>
    ...
    <div class="flex flex-col px-4 py-5 mt-2 w-full text-white rounded-2xl bg-neutral-900 min-h-[672px] max-md:max-w-full">
      ...
      <label class="flex flex-col justify-center px-4 py-2 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[72px] max-md:max-w-full">
        <span class="text-green-200 text-xs">Telegram chat link</span>
      ...
      <label class="flex flex-col justify-center px-4 py-1.5 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[68px] max-md:max-w-full">
        <span class=" text-green-200 text-xs">Telegram channel link</span>
      ...
      <label class="flex flex-col justify-center px-4 py-1.5 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[68px] max-md:max-w-full">
        <span class="text-green-200 text-xs">Twitter link</span>
      ...
      <label class="flex flex-col justify-center px-4 py-1.5 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[68px] max-md:max-w-full">
        <span class="text-green-200 text-xs">Discord link</span>
      ...
      <label class="flex flex-col justify-center px-4 py-1.5 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[68px] max-md:max-w-full">
        <span class="text-green-200 text-xs">Instagram link</span>
      ...
      <label class="flex flex-col justify-center px-4 py-1.5 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[68px] max-md:max-w-full">
        <span class="text-green-200 text-xs">YouTube link</span>
      ...
      <label class="flex flex-col justify-center px-4 py-1.5 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[68px] max-md:max-w-full">
        <span class="text-green-200 text-xs">TikTok link</span>
      ...
      <label class="flex flex-col justify-center px-4 py-1.5 mt-2 w-full rounded-2xl bg-neutral-800 min-h-[68px] max-md:max-w-full">
        <span class="text-green-200 text-xs">Website link</span>
    ...
    <button type="button" class="flex overflow-hidden flex-col mt-2 w-full text-base font-bold text-green-200 bg-neutral-950 max-md:max-w-full" aria-expanded="false">
  ...
  <button type="submit" class="px-96 py-3 mt-2 w-full text-base font-bold leading-loose text-center text-black whitespace-nowrap bg-green-200 te rounded-3xl max-md:px-5 max-md:max-w-full">Connect</button>
</form></div>
  );
}
